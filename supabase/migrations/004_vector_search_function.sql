...
GRANT EXECUTE ON FUNCTION match_content_chunks(vector(1536), float, int, uuid, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION match_content_chunks(vector(1536), float, int, uuid, uuid) TO service_role;
